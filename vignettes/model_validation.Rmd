...
Air temperature is by far the most important predictor. This is not optimal, since air temperature is the only one of the predictors that is influenced by LST. However, it was a result that could be expected. The really small influence of TRI is likely due to the low resolution, which doesn't capture much topographic variance. It is expected that the influence of TRI will rise significantly with higher resolution.
...
## Physical validation by comparison with NDVI
...
cor.test(dry_predictions_lst_ndvi$ndvi, 
         dry_predictions_lst_ndvi$lst_delta_smooth,
         method = "spearman",
         use = "complete.obs")
